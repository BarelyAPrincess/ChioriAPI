 ...
 *
 * Typical use is for another class to implement {@code OptionDeclarer} as a facade, forwarding calls to an {@code OptionParser} instance.
 *
...
public interface OptionDeclarer
{
	 ...
	 * @throws NullPointerException
	 *              if the option list or any of its elements are {@code null}
	 */
	 ...
	 *
	 * @param setting
	 *             {@code true} if the parser should behave "POSIX-ly correct"-ly
	 */
	 ...
	 *
	 * @param recognize
	 *             {@code true} if the parser is to recognize the special style of long options
	 */
