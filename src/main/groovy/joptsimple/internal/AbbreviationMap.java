 ...
 *
 * <p>
 * would make it such that you could retrieve the value {@code "bye"} using the keys {@code "good"} and {@code "goo"}, and the value {@code "fish"} using the key {@code "go"}. The key {@code "g"} would yield {@code null}, since it would no longer be a
 * unique abbreviation.
 * </p>
 *
 * <p>
...
public class AbbreviationMap<V> implements OptionNameMap<V>
{
	 ...
	 *
	 * @param key
	 *             key to create in the map
	 * @param newValue
	 *             value to associate with the key
	 * @throws NullPointerException
	 *              if {@code aKey} or {@code newValue} is {@code null}
	 * @throws IllegalArgumentException
	 *              if {@code aKey} is a zero-length string
	 */
	@Override
	 ...
	 *
	 * @param keys
	 *             keys to create in the map
	 * @param newValue
	 *             value to associate with the key
	 * @throws NullPointerException
	 *              if {@code keys} or {@code newValue} is {@code null}
	 * @throws IllegalArgumentException
	 *              if any of {@code keys} is a zero-length string
	 */
	@Override
