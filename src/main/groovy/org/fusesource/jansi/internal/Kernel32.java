...
public class Kernel32
{
	 ...
	 * @return
	 */
	public static final native int FillConsoleOutputAttribute( @JniArg( cast = "HANDLE", flags = {POINTER_ARG} ) long consoleOutput, short attribute, int length, @JniArg( flags = {BY_VALUE, NO_OUT} ) COORD writeCoord, @JniArg( flags = {NO_IN} ) int[] numberOfAttrsWritten );
	 ...
	 * @return
	 */
	public static final native int FillConsoleOutputCharacterW( @JniArg( cast = "HANDLE", flags = {POINTER_ARG} ) long consoleOutput, char character, int length, @JniArg( flags = {BY_VALUE, NO_OUT} ) COORD writeCoord, @JniArg( flags = {NO_IN} ) int[] numberOfCharsWritten );
	 ...
	 * @return
	 */
	public static final native int FlushConsoleInputBuffer( @JniArg( cast = "HANDLE", flags = {POINTER_ARG} ) long handle );
	 ...
	 * @return
	 */
	public static final native int FormatMessageW( int flags, @JniArg( cast = "void *" ) long source, int messageId, int languageId, @JniArg( cast = "void *", flags = {NO_IN, CRITICAL} ) byte[] buffer, int size, @JniArg( cast = "void *", flags = {NO_IN, CRITICAL, SENTINEL} ) long[] args );
	 ...
	 * @return
	 */
	public static final native int GetConsoleMode( @JniArg( cast = "HANDLE", flags = {POINTER_ARG} ) long handle, @JniArg( flags = {NO_IN} ) int[] mode );
	 ...
	 * @return
	 */
	public static final native int GetConsoleScreenBufferInfo( @JniArg( cast = "HANDLE", flags = {POINTER_ARG} ) long consoleOutput, @JniArg( flags = {NO_IN} ) CONSOLE_SCREEN_BUFFER_INFO consoleScreenBufferInfo );
	 ...
	 *             number of unread input records in the console's input buffer
	 * @return
	 */
	public static final native int GetNumberOfConsoleInputEvents( @JniArg( cast = "HANDLE", flags = {POINTER_ARG} ) long handle, @JniArg( flags = {NO_IN} ) int[] numberOfEvents );
	 ...
	 * @return
	 */
	private static final native int PeekConsoleInputW( @JniArg( cast = "HANDLE", flags = {POINTER_ARG} ) long handle, @JniArg( cast = "PINPUT_RECORD", flags = {POINTER_ARG} ) long inputRecord, int length, @JniArg( flags = {NO_IN} ) int[] eventsCount );
	...
	public static INPUT_RECORD[] readConsoleInputHelper( long handle, int count, boolean peek ) throws IOException
	{
		...
		try
		{
			...
			res = peek ? PeekConsoleInputW( handle, inputRecordPtr, count, length ) : ReadConsoleInputW( handle, inputRecordPtr, count, length );
			if ( res == 0 )
	 ...
	 * @return
	 */
	private static final native int ReadConsoleInputW( @JniArg( cast = "HANDLE", flags = {POINTER_ARG} ) long handle, @JniArg( cast = "PINPUT_RECORD", flags = {POINTER_ARG} ) long inputRecord, int length, @JniArg( flags = {NO_IN} ) int[] eventsCount );
	 ...
	 */
	public static final native int ScrollConsoleScreenBuffer( @JniArg( cast = "HANDLE", flags = {POINTER_ARG} ) long consoleOutput, @JniArg( flags = {NO_OUT} ) SMALL_RECT scrollRectangle, @JniArg( flags = {NO_OUT} ) SMALL_RECT clipRectangle, @JniArg( flags = {BY_VALUE, NO_OUT} ) COORD destinationOrigin, @JniArg( flags = {NO_OUT} ) CHAR_INFO fill );
	 ...
	 * @return
	 */
	public static final native int SetConsoleCursorPosition( @JniArg( cast = "HANDLE", flags = {POINTER_ARG} ) long consoleOutput, @JniArg( flags = {BY_VALUE, NO_OUT} ) COORD cursorPosition );
	 ...
	 * @return
	 */
	public static final native int SetConsoleMode( @JniArg( cast = "HANDLE", flags = {POINTER_ARG} ) long handle, int mode );
	 ...
	 * @return
	 */
	public static final native int SetConsoleTextAttribute( @JniArg( cast = "HANDLE" ) long consoleOutput, short attributes );
	 ...
	 */
	public static final native int SetConsoleTitle( @JniArg( flags = {UNICODE} ) String title );
	 ...
	 * @return
	 */
	public static final native int WriteConsoleW( @JniArg( cast = "HANDLE", flags = {POINTER_ARG} ) long consoleOutput, @JniArg( flags = {NO_OUT} ) char[] buffer, int numberOfCharsToWrite, @JniArg( flags = {NO_IN} ) int[] numberOfCharsWritten, @JniArg( cast = "LPVOID", flags = {POINTER_ARG} ) long reserved );
}
