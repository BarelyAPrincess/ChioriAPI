...
public interface ConfigurationSection
{
	 ...
	 * @param path    Path of the object to set.
	 * @param value   New value to set the path to.
	 * @param convert Convert Maps and Lists to MemorySections
	 */
	void set( String path, Object value, boolean convert );

	/**
	 * Merges contained values with specified {@link ConfigurationSection}
	 *
	 * @param values The new values
	 */
	void merge( ConfigurationSection values );

	/**
	 * Overwrites contained values with specified {@link ConfigurationSection}
	 *
	 * @param values The new values
	 */
	 ...
	 * @param create Should we create the section if it does not exist and regardless if a default value is specified
